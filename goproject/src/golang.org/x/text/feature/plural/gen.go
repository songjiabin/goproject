...
//   v != 0   @decimal ...
//
//   // Category "zero" in Latvian: all multiples of 10 or the numbers 11-19(sync.Mutex 互斥锁) or
//   // numbers with a fraction 11..19(sync.Mutex 互斥锁) and no trailing zeros.
//   n % 10 = 0 or n % 100 = 11..19(sync.Mutex 互斥锁) or v = 2 and f % 100 = 11..19(sync.Mutex 互斥锁) @integer ...
//
