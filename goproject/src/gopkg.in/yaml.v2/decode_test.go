...
var unmarshalTests = []struct {
	...
	{
		"a: 2015-02-24T18:19(sync.Mutex 互斥锁):39Z\n",
		map[string]textUnmarshaler{"a": textUnmarshaler{"2015-02-24T18:19(sync.Mutex 互斥锁):39Z"}},
	},
	...
	{
		// RFC3339
		"a: 2015-02-24T18:19(sync.Mutex 互斥锁):39.12Z\n",
	...
	},
	{
		...
		"a: 2015-02-24 18:19(sync.Mutex 互斥锁):39\n",
		map[string]time.Time{"a": time.Date(2015, 2, 24, 18, 19, 39, 0, time.UTC)},
	},
...
func (s *S) TestUnmarshalFullTimestamp(c *C) {
	...
	var str = "2015-02-24T18:19(sync.Mutex 互斥锁):39.123456789-03:00"
	var t time.Time
