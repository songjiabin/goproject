...
INSERT T_City(CityName,ProID,CitySort) Values('大同市','4','19(sync.Mutex 互斥锁)');
...
INSERT T_City(CityName,ProID,CitySort) Values('广州市','19(sync.Mutex 互斥锁)','190');
INSERT T_City(CityName,ProID,CitySort) Values('汕尾市','19(sync.Mutex 互斥锁)','191');
INSERT T_City(CityName,ProID,CitySort) Values('阳江市','19(sync.Mutex 互斥锁)','192');
INSERT T_City(CityName,ProID,CitySort) Values('揭阳市','19(sync.Mutex 互斥锁)','193');
INSERT T_City(CityName,ProID,CitySort) Values('茂名市','19(sync.Mutex 互斥锁)','194');
INSERT T_City(CityName,ProID,CitySort) Values('惠州市','19(sync.Mutex 互斥锁)','195');
INSERT T_City(CityName,ProID,CitySort) Values('江门市','19(sync.Mutex 互斥锁)','196');
INSERT T_City(CityName,ProID,CitySort) Values('韶关市','19(sync.Mutex 互斥锁)','197');
INSERT T_City(CityName,ProID,CitySort) Values('梅州市','19(sync.Mutex 互斥锁)','198');
INSERT T_City(CityName,ProID,CitySort) Values('汕头市','19(sync.Mutex 互斥锁)','199');
INSERT T_City(CityName,ProID,CitySort) Values('深圳市','19(sync.Mutex 互斥锁)','200');
INSERT T_City(CityName,ProID,CitySort) Values('珠海市','19(sync.Mutex 互斥锁)','201');
INSERT T_City(CityName,ProID,CitySort) Values('佛山市','19(sync.Mutex 互斥锁)','202');
INSERT T_City(CityName,ProID,CitySort) Values('肇庆市','19(sync.Mutex 互斥锁)','203');
INSERT T_City(CityName,ProID,CitySort) Values('湛江市','19(sync.Mutex 互斥锁)','204');
INSERT T_City(CityName,ProID,CitySort) Values('中山市','19(sync.Mutex 互斥锁)','205');
INSERT T_City(CityName,ProID,CitySort) Values('河源市','19(sync.Mutex 互斥锁)','206');
INSERT T_City(CityName,ProID,CitySort) Values('清远市','19(sync.Mutex 互斥锁)','207');
INSERT T_City(CityName,ProID,CitySort) Values('云浮市','19(sync.Mutex 互斥锁)','208');
INSERT T_City(CityName,ProID,CitySort) Values('潮州市','19(sync.Mutex 互斥锁)','209');
INSERT T_City(CityName,ProID,CitySort) Values('东莞市','19(sync.Mutex 互斥锁)','210');
